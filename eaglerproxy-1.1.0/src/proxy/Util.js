...
const leb128_1 = require("@thi.ng/leb128");
const parse_domain_1 = require("parse-domain");
const promises_1 = require("fs/promises");
const path_1 = require("path");
var Util;
(function (Util) {
    Util.encodeVarInt = leb128_1.encodeULEB128;
    Util.decodeVarInt = leb128_1.decodeULEB128;
    const USERNAME_REGEX = /[^0-9^a-z^A-Z^_]/gi;
    function generateUUIDFromPlayer(user) {
        const str = `OfflinePlayer:${user}`;
        let md5Bytes = (0, crypto_1.createHash)("md5").update(str).digest();
    ...
    function areDomainsEqual(d1, d2) {
        ...
        const parseResult1 = (0, parse_domain_1.parseDomain)(d1), parseResult2 = (0, parse_domain_1.parseDomain)(d2);
        if (parseResult1.type != parse_domain_1.ParseResultType.Invalid && parseResult2.type != parse_domain_1.ParseResultType.Invalid) {
            if (parseResult1.type == parse_domain_1.ParseResultType.Ip && parseResult2.type == parse_domain_1.ParseResultType.Ip) {
                return parseResult1.hostname == parseResult2.hostname ? true : false;
            }
            else if (parseResult1.type == parse_domain_1.ParseResultType.Listed && parseResult2.type == parse_domain_1.ParseResultType.Listed) {
            ...
            else if (parseResult1.type == parse_domain_1.ParseResultType.NotListed && parseResult2.type == parse_domain_1.ParseResultType.NotListed) {
            ...
            else if (parseResult1.type == parse_domain_1.ParseResultType.Reserved && parseResult2.type == parse_domain_1.ParseResultType.Reserved) {
