...
(function (BungeeUtil) {
    class PacketUUIDTranslator {
        constructor(ssPlayerUUID, csPlayerUUID) {
            ...
            this._logger = new logger_js_1.Logger("PacketTranslator");
        }
    ...
    PacketUUIDTranslator.CAST_UUID_CLIENT = ["spectate"];
...
})(BungeeUtil = exports.BungeeUtil || (exports.BungeeUtil = {}));
